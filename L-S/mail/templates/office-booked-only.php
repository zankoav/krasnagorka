                        ...
                        <tr>
                            <td colspan="6" style="padding: 0 30px 20px;color:#000;font:400 14px/21px 'arial' , 'helvetica' , sans-serif">
                                ...
                                <div>В стоимость уже включены комиссии платежных систем, туристический сбор не
                                    требуется.
                                    <div>Предоплата вносится в размере <strong><?= $order->subprice ?></strong> белорусских рублей в течение двух календарных дней с момента бронирования. Менеджер свяжется с вами для уточнения деталей.
                                    </div>
                                    <div style="line-height: 1; margin-top:12px;">
                                        ...
                                        ?>
                                        <small style="color:#999;"><span style="color:#f00;">*</span><?= $addedMessage; ?></small>
                                    </div>
                            </td>
                        </tr>
                        <tr>
