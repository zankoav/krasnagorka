...
$until = date('d.m.Y', strtotime($created . ' + 2 days'));
$source = get_post_meta($order->id, 'sbc_order_prepaid_source', 1);
?>
                            ...
                            <td colspan="6" style="padding: 0 30px 20px;color:#000;font:400 14px/21px 'arial' , 'helvetica' , sans-serif">
                                ...
                                <div>В стоимость уже включены комиссии платежных систем, туристический сбор не
                                    ...
                                    <div>Предоплата вносится в размере
                                        <strong><?= $order->subprice ?></strong> белорусских рублей <strong>онлайн по ссылке, отправленной на e-mail в течение двух календарных дней с момента бронирования.</strong>
                                    </div>
                        ...
                        <tr>
                            <td colspan="6" style="padding: 0 30px 20px;color:#000;font:400 14px/21px 'arial' , 'helvetica' , sans-serif">
                                ...
                                <div>Данная заявка свидетельствует о том, что Вы совершили бронирование через сайт
                                    <a style="color: #1498c6; text-decoration: underline;" href="https://krasnagorka.by">krasnagorka.by</a> и приняли условия
                                ...
                                <div>Бронирование будет действительно в течение двух календарных дней. В случае неоплаты по истечению указанного периода – бронирование считается аннулированным.</div>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="6" style="padding: 0 30px 20px;color:#000;font:400 14px/21px 'arial' , 'helvetica' , sans-serif">
                                ...
                                <div>
                                    Для отмены бронирования просьба позвонить или отправить сообщение по контактам, указанным выше, спасибо!
                                </div>
                            </td>
                        </tr>
                    </tbody>
