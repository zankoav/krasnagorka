    ...
    (($) => {
        ...
        const template = () => {
            return encodeURI(`
                ...
                \n
                <b>Скидка 30%</b>
                <span>Комфортный, уютный домик на троих с собственной барбекю зоной и шикарным видом на лес и озеро. Расположен вдали от остальных домов.</span>
                <span>c 06.01 по 08.01<span>
            `);
        }
