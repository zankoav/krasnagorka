...
<section class="b-bgc-wrapper b-pb-2">
    ...
    <div class="swiper-container about-us-slider">
        <div class="swiper-wrapper about-us-slider__wrapper">
            ...
            ?>
                <div class="swiper-slide about-us-slider__slide" data-swiper-autoplay="<?= $portfolio_slider_delay; ?>">
                    <img class="object-fit-img" src="<?= wp_get_attachment_image_url($itemImageId, $image_size) ?>" srcset="<?= wp_get_attachment_image_srcset($itemImageId, $image_size) ?>" sizes="<?= wp_get_attachment_image_sizes($itemImageId, $image_size) ?>">
