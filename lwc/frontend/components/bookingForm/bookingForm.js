        ...
        if(this.pay){
            ...
            .then(result => {
                ...
                if(result.status === 2){
                    ...
                    result.values.wsb_phone = '375291234567';
                    result.values.wsb_email = email;
                    result.values.wsb_service_date = 'Минск ул. Шафарнянская д.11 оф.54';
                    result.values.wsb_customer_address = 'Доставка до 1 января 2016 года';
                    /**
