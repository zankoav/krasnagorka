...
export default class EventItem extends LightningElement {
    ...
    get href() {
        return `https://krasnagorka.by/booking-form/?eventId=${this.group.eventId}&calendarId=${this.selectedApportament}&people=${this.selectedPeople}&variant=${this.selectedVar}`
    }
