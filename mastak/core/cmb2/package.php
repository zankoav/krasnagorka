...
function register_post_type_package()
{
    register_post_type(
        ...
        array(
            'label'               => null,
            'labels'              => array(
                'name'               => 'Форма брони', // основное название для типа записи
                'singular_name'      => 'Форма брони', // название для одной записи этого типа
                ...
                'menu_name'          => 'Формы броней', // название меню
            ),
            'description'         => '',
            'public'              => false,
...
function cmb_package()
{
    ...
    $cmb_package->add_field(array(
        'name'    => __('Скидка в процентах', 'krasnagorka'),
        'id'      => 'package_sale_percent',
        'type'            => 'text',
        'attributes'      => array(
            'type'    => 'number',
            'pattern' => '\d*',
