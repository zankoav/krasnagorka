                ...
                on: {
                    beforeTransitionStart: function (swiper) {
                        const slideSecond = document.querySelector(
                            '.main-slider__slide[data-swiper-slide-index="1"]:not(.swiper-slide-duplicate)'
                        )
                        const firstSlide = document.querySelector(
                            '.main-slider__slide[data-swiper-slide-index="0"]:not(.swiper-slide-duplicate)'
                        )

                        const targetSlide = slideSecond || firstSlide
                        if (targetSlide) {
                            const slideContent = targetSlide.querySelector(
                                '.main-slider__slide-content'
                            )
                            const htmlNew = slideContent.innerHTML.replaceAll('div', 'h1')
                            slideContent.innerHTML = htmlNew
                        }
                    },
