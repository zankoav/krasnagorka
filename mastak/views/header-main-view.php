                    ...
                    <div class="menu-main__scroll-content-wrapper">
                        ...
                        <?php if ($video) : ?>
                            <a href="#" class="online-video online-video--menu">
                                <img src="<?= CORE_PATH; ?>assets/icons/online-video-gray.svg" alt="online-video" class="online-video__icon">
        ...
        <div class="swiper-wrapper main-slider__wrapper">
            ...
            foreach ($main_slider as $m_slide) : ?>
                <div class="swiper-slide main-slider__slide" data-swiper-autoplay="<?= $main_slider_delay; ?>">
                    ...
                    <?php else : ?>
                        <div class="main-slider__slide-img-wrapper">
                            <img class="object-fit-img" src="<?= wp_get_attachment_image_url($m_slide["slide_image_id"], $image_size) ?>" srcset="<?= wp_get_attachment_image_srcset($m_slide["slide_image_id"], $image_size) ?>" sizes="<?= wp_get_attachment_image_sizes($m_slide["slide_image_id"], $image_size) ?>">
                        </div>
                    <?php endif; ?>
