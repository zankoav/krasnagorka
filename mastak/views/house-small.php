    ...
    <div class="our-house">
        ...
        <div class="our-house__content <?= $isTerem ? 'our-house__content_terem' : ''; ?>">
            <div class="our-house__apartments">
                ...
                <p class="added-info-price added-info-price_first"><span class="added-info-price__star">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="18px" height="25px" viewBox="0 0 18 25" version="1.1">
                        <g id="Symbols" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" stroke-linecap="round" stroke-linejoin="round">
                            <g id="t_g-contacts-footer" transform="translate(-568.000000, -63.000000)" fill-rule="nonzero" stroke="#d0021b">
                    ...
                    </span><a href="https://krasnagorka.by/shema-proezda/" target="_blank">Браславские озёра (оз. Снуды), д. Красногорка</a>
                </p>
            </div>
            <?php if (!$isTerem) : ?>
